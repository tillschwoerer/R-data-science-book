...
* For all punctuation marks a backslash is put in front. E.g. "\\\?" is the regular expression for the question mark: "?". But to write "?" in R, you have to use two backslahes: "\\\\?"
